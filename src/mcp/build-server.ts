...
import { registerEffectTools } from '../tools/effect-tools.ts';
import { registerDisplayTools, registerEntityTools } from '../tools/entity-tools.ts';
...
export function buildMcpServer(registry: BotRegistry, caller?: string): McpServer {
  ...
  registerDisplayTools(server, registry);
  ...
  registerEffectTools(server, registry);
